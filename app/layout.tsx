...
fbq('init', '2129838724322410');
fbq('track', 'PageView');`}</Script>
    <noscript><img height="1" width="1" style={{ display: "none" }} src="https://www.facebook.com/tr?id=2129838724322410&ev=PageView&noscript=1" alt="" /></noscript>
    {children}
  </body></html>;
}
